    ...
    <footer class="py-12 px-6 bg-cream dark:bg-[#1a1f2e] border-t border-navy/5 dark:border-white/5">
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <p class="text-sm text-navy-light dark:text-gray-400 flex items-center gap-1">
                    Made with
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#E57373" class="w-4 h-4">
